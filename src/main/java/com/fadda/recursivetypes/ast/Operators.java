...
public class Operators {
    ...
    public static final Map<OperatorId, Operator> operators = new HashMap<>();
    ...
    public static void addOperators() {
        ...
        Operator toDouble = Operator.of1("toDouble", Type.Int, Type.Double, Operators::toDouble);
        Operators.operators.put(toDouble.id(), toDouble);
        Operator toInt = Operator.of1("toInt", Type.Double, Type.Int, Operators::toInt);
