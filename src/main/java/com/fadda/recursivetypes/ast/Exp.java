...
public interface Exp {
    ...
    static void toDot(String file, Exp e) {
    ...
    static Exp of(List<Exp> operands, Operator op) {
        return switch (op.id().arity()) {
    ...
    static List<Exp> ofOperatorsInLevels(List<List<Operator>> operators) {
