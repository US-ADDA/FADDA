...
public class ProgramParser extends Parser {
    ...
    public static class FunDeclarationSPContext extends DeclarationContext {
        ...
        public FunDeclarationSPContext(DeclarationContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode ID() {
            return getToken(ProgramParser.ID, 0);
        }

        public TerminalNode TYPE() {
            return getToken(ProgramParser.TYPE, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProgramVisitor)
                return ((ProgramVisitor<? extends T>) visitor).visitFunDeclarationSP(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunDeclarationContext extends DeclarationContext {
        ...
        public FunDeclarationContext(DeclarationContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProgramVisitor)
                return ((ProgramVisitor<? extends T>) visitor).visitFunDeclaration(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VarDeclarationContext extends DeclarationContext {
        ...
        public VarDeclarationContext(DeclarationContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProgramVisitor)
                return ((ProgramVisitor<? extends T>) visitor).visitVarDeclaration(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Formal_parametersContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProgramVisitor)
                return ((ProgramVisitor<? extends T>) visitor).visitFormal_parameters(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Formal_parameterContext extends ParserRuleContext {
        ...
        public List<TerminalNode> ID() {
            return getTokens(ProgramParser.ID);
        }
        ...
        public List<TerminalNode> TYPE() {
            return getTokens(ProgramParser.TYPE);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProgramVisitor)
                return ((ProgramVisitor<? extends T>) visitor).visitFormal_parameter(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IfSentenceContext extends SentenceContext {
        ...
        public IfSentenceContext(SentenceContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class AsignSentenceContext extends SentenceContext {
        ...
        public AsignSentenceContext(SentenceContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProgramVisitor)
                return ((ProgramVisitor<? extends T>) visitor).visitAsignSentence(this);
            else return visitor.visitChildren(this);
        }
    }

    public static class WhileSentenceContext extends SentenceContext {
        public WhileSentenceContext(SentenceContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProgramVisitor)
                return ((ProgramVisitor<? extends T>) visitor).visitWhileSentence(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StrExprContext extends ExpContext {
        public StrExprContext(ExpContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode STR() {
            return getToken(ProgramParser.STR, 0);
        }
    ...
    public static class UnaryExprContext extends ExpContext {
        ...
        public UnaryExprContext(ExpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IntExprContext extends ExpContext {
        ...
        public TerminalNode INT() {
            return getToken(ProgramParser.INT, 0);
        }
    ...
    public static class BinaryExprContext extends ExpContext {
        ...
        public BinaryExprContext(ExpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CallExprContext extends ExpContext {
        ...
        public CallExprContext(ExpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BoolExprContext extends ExpContext {
        public BoolExprContext(ExpContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode BOOL() {
            return getToken(ProgramParser.BOOL, 0);
        }
    ...
    public static class DoubleExpContext extends ExpContext {
        ...
        public TerminalNode DOUBLE() {
            return getToken(ProgramParser.DOUBLE, 0);
        }
    ...
    public static class Real_parametersContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProgramVisitor)
                return ((ProgramVisitor<? extends T>) visitor).visitReal_parameters(this);
            else return visitor.visitChildren(this);
        }
    }
}
