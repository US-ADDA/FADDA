...
public class BinaryTreeParser extends Parser {
    ...
    public static class LabelTreeContext extends Binary_treeContext {
        public LabelTreeContext(Binary_treeContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BinaryTreeVisitor)
                return ((BinaryTreeVisitor<? extends T>) visitor).visitLabelTree(this);
            else return visitor.visitChildren(this);
        }
    }

    public static class EmptyTreeContext extends Binary_treeContext {
        public EmptyTreeContext(Binary_treeContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BinaryTreeVisitor)
                return ((BinaryTreeVisitor<? extends T>) visitor).visitEmptyTree(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BinaryTreeContext extends Binary_treeContext {
        ...
        public BinaryTreeContext(Binary_treeContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BinaryTreeVisitor)
                return ((BinaryTreeVisitor<? extends T>) visitor).visitBinaryTree(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IntLabelContext extends LabelContext {
        public IntLabelContext(LabelContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode INT() {
            return getToken(BinaryTreeParser.INT, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BinaryTreeVisitor)
                return ((BinaryTreeVisitor<? extends T>) visitor).visitIntLabel(this);
            else return visitor.visitChildren(this);
        }
    }

    public static class IdLabelContext extends LabelContext {
        public IdLabelContext(LabelContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode ID() {
            return getToken(BinaryTreeParser.ID, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BinaryTreeVisitor)
                return ((BinaryTreeVisitor<? extends T>) visitor).visitIdLabel(this);
            else return visitor.visitChildren(this);
        }
    }

    public static class DoubleLabelContext extends LabelContext {
        public DoubleLabelContext(LabelContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode DOUBLE() {
            return getToken(BinaryTreeParser.DOUBLE, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BinaryTreeVisitor)
                return ((BinaryTreeVisitor<? extends T>) visitor).visitDoubleLabel(this);
            else return visitor.visitChildren(this);
        }
    }
}
