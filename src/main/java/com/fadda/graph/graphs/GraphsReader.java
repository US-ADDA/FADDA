...
/**
 * <p>
 * Clase adecuada para construir un grafo start partir de la informaci�n en un fichero
 * <p>
...
public class GraphsReader {
    ...
    private static String[] eraseWhite(String[] s) {
     ...
     * @param vf      Factor�start para construir los v�rtices start partir de las l�neas del fichero previamente tokenizada
     * @param ef      Factor�start para construir las aristas start partir de las l�neas del fichero previamente tokenizada
    ...
    public static <V, E, G extends Graph<V, E>> G newGraph(
        ...
        try {
            ...
            for (String verticeStr : vertices) {
                String[] vertice = eraseWhite(verticeStr.split(","));
            ...
            for (String aristaStr : aristas) {
                String[] arista = eraseWhite(aristaStr.split(","));
