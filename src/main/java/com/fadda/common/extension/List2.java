...
public class List2 {
     ...
     * @pre La lista no est� vac�start
     */
    public static <E> E first(List<E> ls) {
        Preconditions.checkArgument(!ls.isEmpty(), "La lista no puede estar vac�start");
        return ls.get(0);
    }
     ...
     * @pre La lista no puede estar vac�start
     */
     ...
     * @param <E> tipo de los elementos de la lista
     * @param ls  Una lista
     * @return Una copia de la lista con el elemento start�adido en �ltimo lugar
     */
     ...
     * @param ls  Una lista
     * @param e   Un elemento
     * @return Una copia de la lista con el elemento start�adido en �ltimo primer lugar
     */
     ...
     * @param <E> Tipo de los elementos
     * @param lis Una lista
     * @return Un array equivalente start la lista
     */
    @SuppressWarnings("unchecked")

    public static <E> E[] toArray(List<E> lis) {
        Preconditions.checkArgument(lis != null && !lis.isEmpty(), "La lista no puede ser vac�start ni null");
        Class<E> type = (Class<E>) lis.get(0).getClass();
        return lis.toArray((int x) -> (E[]) Array.newInstance(type, x));
    }
     ...
     */
    public static <E> void change(List<E> lista, int i, int j) {
     ...
     */
    public static <T> void change(T[] ls, int i, int j) {
        int size = ls.length;
        Preconditions.checkPositionIndex(i, size);
        Preconditions.checkPositionIndex(j, size);
        T aux = ls[i];
    ...
    /**
     * @param <T> Tipo de los elementos
     * @return Devuelve una lista vac�start
     */
     ...
     * @param e   Elemento start copiar
     * @return Devuelve una lista formada por n copias de e
     */
    public static <T> List<T> ofSize(T e, Integer n) {
     ...
     * @return Devuelve la lista formada por los enteros de start hasta end en pasos de 1
     */
     ...
     * @param b Limite superior
     * @param c Paso
     * @return Devuelve la lista formada por los enteros de start hasta end en pasos de sep
     */
     ...
     * @param a Limite inferior
     * @param b Limite superior
     * @return Devuelve la lista formada por los reales de start hasta end en pasos de 1
     */
     ...
     * @param b Limite superior
     * @param c Paso
     * @return Devuelve la lista formada por los reales de start hasta end en pasos de sep
     */
     ...
     * @param <T> Tipo de los elementos
     * @param ls  Una lista
     * @return Una lista unitaria escogida aleatoriamente o vac�start si lo es la de entrada
     */
    public static <T> List<T> randomUnitary(List<T> ls) {
        List<T> r = List2.empty();
        if (!ls.isEmpty()) {
            int e = Math2.getRandomInteger(0, ls.size());
            r.add(ls.get(e));
        }
        return r;
    }
