...
public class LargeInteger implements Comparable<LargeInteger> {
    ...
    /**
     * Los d�gitos est�n ordenados de m�s significativo a menos significativos
     */
    ...
    /**
     * @return Multiplica por la base a�adiendo un cero a la derecha
     */
     ...
     * @return Un nuevo entero largo completado con d�gitos no significativos a la izquierda
     */
    ...
    /**
     * @param m Un entero
     * @return Multiplica por la base elevada a m a�adiendo m ceros a las derecha
     */
