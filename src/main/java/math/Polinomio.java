...
public class Polinomio {
    ...
    private static final Double[] one = {0., 1.};
    private static final Polinomio pzero = Polinomio.create(zero);
    private static final Polinomio pone = Polinomio.create(one);
        ...
        for (int i = 0; i < coeficientes.length; i++) {
            ...
            if (d != 0.) {
                if (i == 0) {
                    ...
                    s.append(rc).append("X ");
                } else {
                    s.append(rc).append("X^").append(i).append(" ");
                }
            }
        }
    ...
    public boolean equals(Object obj) {
        ...
        return Arrays.equals(coeficientes, other.coeficientes);
    }
