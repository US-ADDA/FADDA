...
import main.java.common.views.View4;
...
public class Matrix<E> {
    ...
    public Matrix<E> view(Integer nv) {
        ...
        switch (nv) {
            ...
            case 3:
                ...
                break;
            default:
                Preconditions.checkArgument(false, "Opci�n no v�lida");
        }
        return r;
    }
    ...
    public static <E extends FieldElement<E>> Matrix<E> multiply_r(Matrix<E> m1, Matrix<E> m2) {
        ...
        Preconditions.checkArgument(ch, String.format("No se cumplen condiciones de multiplicaci�n = (in1.nc = %d, in2.nf = %d)", m1.nc, m2.nf));
